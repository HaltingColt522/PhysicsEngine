...
void Window::createCommandBuffers() {
    commandBuffers.resize(Const::MAX_FRAMES_IN_FLIGHT);
...
void Window::createSyncObjects() {
    imageAvailableSemaphores.resize(Const::MAX_FRAMES_IN_FLIGHT);
    renderFinishedSemaphores.resize(Const::MAX_FRAMES_IN_FLIGHT);
    inFlightFences.resize(Const::MAX_FRAMES_IN_FLIGHT);
...
void Window::drawFrame() {
    ...
    currentFrame = (currentFrame + 1) % Const::MAX_FRAMES_IN_FLIGHT;
}
...
bool Window::checkValidationLayerSupport() {
    ...
    for (const char* layerName : Const::validationLayers) {
